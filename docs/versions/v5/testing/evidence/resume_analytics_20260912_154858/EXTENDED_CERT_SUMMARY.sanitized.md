...
Run: resume_analytics_20260912_154858
Started: 2026-09-12T19:49:01.141Z
Finished: 2026-09-12T19:49:50.418Z
...
| Large purchase preserved state | PASS | 29 lines / 29 bottles / 29 stock movements |
| Preserved POS/return certification | PASS | 7 sales / 6 distinct products / CASH 3 / UPI 2 / CARD 2 / approved return present |
| Targeted shift/day close | PASS | opening 100 / cash sales 260 / expected 360 / actual 360 / variance 0 |
| Owner Center headline metrics | PASS | Revenue · Gross Profit · Operating Profit · Inventory Cost · bills · low stock match RPC |
| Owner Center graphs | PASS | Sales Trend · CASH/UPI/CARD Payment Mix · Top Products match authoritative sales data |
| Inventory Intelligence | PASS | 29 health rows · metric counts and stock row match RPC |
| Profit Intelligence | PASS | Revenue · COGS · Gross Profit · Operating Profit match RPC |
| Purchase Intelligence | PASS | Budweiser Beer latest purchase price matches history RPC |
...
```json
{
  "purchaseId": "71a87bce-db2f-47a7-b422-48c0d84d0462",
  "invoiceNumber": "E2E-LARGE-20260912_144723",
  "lineCount": 29,
  "purchasedBottles": 29,
  "movementCount": 29,
  "resumed": true
...
```json
{
  "ownerCenter": {
    "summary": {
      ...
      "expenses": 0,
      "purchases": 267635.24,
      "gross_profit": 357.491667,
      "cash_variance": -475,
      "inventory_cost": 266259.252857,
      "low_stock_count": 0,
      "operating_profit": 357.491667
    },
    ...
    "topProducts": [
      {
        "label": "Budweiser Magnum Strong Beer",
        "value": 1100
      },
      {
      ...
      {
        "label": "Budweiser Magnum Strong Beer Can",
        "value": 215
      }
    ]
  },
  "inventoryIntelligence": {
    ...
    "checkedProduct": "Canon 10000 Super Strong Beer"
  },
  "ownerProfit": {
    "summary": {
      "to": "2026-09-12",
...
- locator.waitFor: Error: strict mode violation: getByRole('heading', { name: 'Reports' }) resolved to 3 elements:
    1) <h1>Reports & Compliance</h1> aka locator('header').getByRole('heading', { name: 'Reports & Compliance' })
    2) <h1>Reports & Compliance</h1> aka getByRole('heading', { name: 'Reports & Compliance' }).nth(1)
    3) <h2>Reports & Exports</h2> aka getByRole('heading', { name: 'Reports & Exports' })

Call log:
[2m  - waiting for getByRole('heading', { name: 'Reports' }) to be visible[22m

    at reportsValidation (E:\WineShopPOS_V5_E2E_20260912_105856\tests\e2e\.wsp_v5_resume_19wH52.mjs:817:52)
    at async file:///E:/WineShopPOS_V5_E2E_20260912_105856/tests/e2e/.wsp_v5_resume_19wH52.mjs:931:3
