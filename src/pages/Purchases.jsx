...
export default function Purchases(){
 ...
 function applyBarcode(i,code,source="SCANNER"){
   ...
   if(!r.productId){
     ...
     setMessage(`Barcode ${scan} received from ${source==="PAIRED_PHONE"?"paired phone":"scanner"} and saved in the purchase draft only.`);
     return;
   }
