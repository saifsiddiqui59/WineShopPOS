...
if [ "$WSP_GUARD_BRANCH" != "main" ]; then
  echo "ENVIRONMENT_ISOLATION_BLOCKED: production-targeting executor E:/WineShopPOS_V3/scripts/create_document_intelligence_f0.sh cannot run from branch $WSP_GUARD_BRANCH" >&2
  exit 97
fi
set -euo pipefail
